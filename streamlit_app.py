...
from dashboard.config import MODEL_RESULT_FILES
...
def main() -> None:
    ...
    st.caption("LendingClub model results, threshold tuning, feature importance, and EDA figures.")
    ...
    page = st.sidebar.radio(
        "View",
        options=["Model Comparison", "Model Detail", "EDA Figures"],
    )
